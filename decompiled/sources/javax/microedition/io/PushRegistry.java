...
/* loaded from: avacs.jar:javax/microedition/io/PushRegistry.class */
public class PushRegistry {
    private static PushRegistryDelegate impl = (PushRegistryDelegate) ImplFactory.getImplementation(PushRegistry.class, PushRegistryDelegate.class);
    ...
    public static long registerAlarm(String midlet, long time) throws ConnectionNotFoundException, ClassNotFoundException {
