...
/* loaded from: avacs.jar:org/microemu/device/j2se/J2SEFontManager.class */
public class J2SEFontManager implements FontManagerImpl {
    ...
    private static int SIZE_SMALL = 8;
    private static int SIZE_MEDIUM = 8;
    ...
    Font getFont(javax.microedition.lcdui.Font meFont) {
        ...
        if (result == null) {
            ...
            result = new J2SESystemFont(name, style2, size, this.antialiasing);
