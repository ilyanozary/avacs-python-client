...
/* loaded from: avacs.jar:org/microemu/app/capture/LZWEncoder.class */
class LZWEncoder {
    ...
    int cur_accum = 0;
    int cur_bits = 0;
    int[] masks = {0, 1, 3, 7, 15, 31, 63, Opcodes.LAND, 255, 511, 1023, 2047, 4095, 8191, 16383, 32767, TextField.CONSTRAINT_MASK};
